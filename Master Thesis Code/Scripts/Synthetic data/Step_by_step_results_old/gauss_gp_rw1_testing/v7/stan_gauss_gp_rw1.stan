...
// Implemented with "Difference 1" random walks
...
transformed parameters {
  ...
  vector[8] alpha_diff = alpha[2:9] - alpha[1:8];
  // your mistake: you had vector[18] instead of vector[17] for a moment
  vector[17] kappa_diff = kappa[2:18] - kappa[1:17];
