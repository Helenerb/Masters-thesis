// Stan profgram modelling the lc model, where the period effect is modelled
// as a random walk with drift. The first element of the period effect
// is given a standard normal distribution as a prior, but no further constraints
// (soft constraints)
