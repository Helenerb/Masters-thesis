...
run_stan_traditional_lc(stan_program="Scripts/Synthetic\ data/Stan\ analyses/stan_programs/stan_lc_traditional.stan", chains=3, warmup = 13000, iter = 130000, markov=T)
