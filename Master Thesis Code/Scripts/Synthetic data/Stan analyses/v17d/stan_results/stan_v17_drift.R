...
run_stan_v17d <- function(stan_program, chains=4, warmup=1000, iter=10000, markov=TRUE){
  output.path <- set_workspace(config="v17d", markov)
...
run_stan_v17d(stan_program="stan_analysis_lcc_rw_drift.stan", chains=4, warmup = 1000, iter = 10000, markov=TRUE)
