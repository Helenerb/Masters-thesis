...
run_stan_tllp_fixed_hypers_v4 <- function(stan_program, chains=4, warmup=1000, iter=10000, markov=TRUE){
  output.path <- set_workspace(config="traditional_lc_log_prec/v4_fixed_hypers", markov)
  library("tidyverse")
...
run_stan_tllp_fixed_hypers_v4(stan_program="Scripts/Synthetic\ data/Stan\ analyses/stan_programs/stan_tllp_sc_fixed_hypers.stan", chains=4, warmup = 20000, iter = 200000, markov=T)
