...
run_stan_male_stomach_lc(stan_program="Scripts/Synthetic\ data/Stan\ analyses/stan_programs/stan_analysis_lc_rw2.stan", chains=2, warmup = 50, iter = 100, markov=TRUE)
