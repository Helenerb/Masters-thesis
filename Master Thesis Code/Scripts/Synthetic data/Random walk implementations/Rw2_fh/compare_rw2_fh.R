...
set_workspace <- function(markov=TRUE){
  if(markov){
    ...
    setwd("~/Documents/GitHub/Masteroppgave/Masters-thesis/Master Thesis Code/Scripts/Synthetic data/Random walk implementations/Rw2_fh")
  } else {
    setwd("~/Desktop/Masteroppgave/Masters-thesis/Master Thesis Code/Scripts/Synthetic data/Random walk implementations/Rw2_fh")
  }
}
...
fit_diff_1 <- stan(
  file = "rw2_fh_by_differences_1.stan",
  data = input_stan,
  chains = 4,
  iter = 800,
  warmup = 80,
...
fit_diff_2 <- stan(
  file = "rw2_fh_by_differences_2.stan",
  data = input_stan,
  chains = 4,
  iter = 800,
  warmup = 80,
...
fit_diff_3 <- stan(
  file = "rw2_fh_by_differences_3.stan",
  data = input_stan,
  chains = 4,
  iter = 800,
  warmup = 80,
...
fit_diff_4 <- stan(
  file = "rw2_fh_by_differences_4.stan",
  data = input_stan,
  chains = 4,
  iter = 800,
  warmup = 80,
