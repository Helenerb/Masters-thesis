...
p.pred.3 <- ggplot(pred.3.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=3", x = "", y = "")
...
p.pred.5 <- ggplot(pred.5.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=5", x = "", y = "")
...
p.pred.8 <- ggplot(pred.8.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=8", x = "", y = "")
...
p.pred.11 <- ggplot(pred.11.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=11", x = "", y = "")
...
p.pred.14 <- ggplot(pred.14.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=14", x = "", y = "")
...
p.pred.18 <- ggplot(pred.18.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=18", x = "", y = "")
...
p.pred.22 <- ggplot(pred.22.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=22", x = "", y = "")
...
p.pred.26 <- ggplot(pred.26.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=26", x = "", y = "")
...
p.pred.30 <- ggplot(pred.30.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=30", x = "", y = "")
...
p.pred.34 <- ggplot(pred.34.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=34", x = "", y = "")
...
p.pred.38 <- ggplot(pred.38.inlabru) + 
  ...
  scale_color_manual(name = "", values = palette) + 
  scale_fill_manual(name = "", values = palette) + 
  labs(title = "Predictor at xt=38", x = "", y = "")
