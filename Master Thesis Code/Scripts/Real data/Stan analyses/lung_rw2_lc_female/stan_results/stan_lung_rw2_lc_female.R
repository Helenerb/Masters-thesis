...
run_stan_lung_rw2_lc_female <- function(stan_program, chains=4, warmup=1000, iter=10000, markov=TRUE){
  config = "lung_rw2_lc_female"
...
run_stan_lung_rw2_lc_female(stan_program="../Synthetic\ data/Stan\ analyses/stan_programs/stan_analysis_lc_rw2.stan", chains=5, warmup = 20000, iter = 200000, markov=TRUE)
