...
run_stan_stomach_rw2_lc_male(stan_program="../Synthetic\ data/Stan\ analyses/stan_programs/stan_analysis_lc_rw2.stan", chains=6, warmup = 20000, iter = 200000, markov=TRUE)
