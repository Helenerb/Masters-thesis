...
run_stan_stomach_rw2_lc <- function(stan_program, chains=4, warmup=1000, iter=10000, markov=TRUE){
  config = "stomach_rw2_lc"
...
run_stan_stomach_rw2_lc(stan_program="../Synthetic\ data/Stan\ analyses/stan_programs/stan_analysis_lc_rw2.stan", chains=4, warmup = 20000, iter = 400000, markov=TRUE)
