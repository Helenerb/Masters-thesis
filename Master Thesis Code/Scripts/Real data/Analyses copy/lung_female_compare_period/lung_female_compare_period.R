...
lambda.samples.rw2 <- generate(res.inlabru.rw2, female.lung.cancer, ~ E*exp(alpha + beta*kappa + gamma + epsilon), n.samples = 10000)
Y.samples.rw2 <- matrix(rpois(lambda.samples.rw2, n = 324*10000), nrow = 324, ncol = 10000)
...
contained.all.rw2 <- mean(Y.inlabru.rw2$contained)

contained.95.in.data.rw2 <- mean({Y.inlabru.rw2 %>% filter(year %in% 1999:2010)}$contained)
contained.95.out.data.rw2 <- mean({Y.inlabru.rw2 %>% filter(year %in% 2011:2016)}$contained)

contained.95.a.5.in.data.rw2 <- mean({Y.inlabru.rw2 %>% filter(x > 5) %>% filter(year %in% 1999:2010)}$contained)
contained.95.a.5.out.data.rw2 <- mean({Y.inlabru.rw2 %>% filter(x > 5) %>% filter(year %in% 2011:2016)}$contained)
...
write.table(list(MDSS.all = MDSS.all.rw2,
                 ...
                 above.5.out.data = MDSS.x.above.5.out.data.rw2,
                 contained.95.in.data.rw2 = contained.95.in.data.rw2,
                 contained.95.a.5.in.data.rw2 = contained.95.a.5.in.data.rw2,
                 contained.95.out.data.rw2 = contained.95.out.data.rw2,
                 contained.95.a.5.out.data.rw2 = contained.95.a.5.out.data.rw2,
                 contained.all.rw2 = contained.all.rw2), file = file.path(output.path, "DSS_rw2.txt"))
...
lambda.samples.drift <- generate(res.inlabru.drift, female.lung.cancer, ~ E*exp(alpha + beta*phi + beta*kappa + gamma + epsilon), n.samples = 10000)
Y.samples.drift <- matrix(rpois(lambda.samples.drift, n = 324*10000), nrow = 324, ncol = 10000)
...
contained.all.drift <- mean(Y.inlabru.drift$contained)

contained.95.in.data.drift <- mean({Y.inlabru.drift %>% filter(year %in% 1999:2010)}$contained)
contained.95.out.data.drift <- mean({Y.inlabru.drift %>% filter(year %in% 2011:2016)}$contained)

contained.95.a.5.in.data.drift <- mean({Y.inlabru.drift %>% filter(x > 5) %>% filter(year %in% 1999:2010)}$contained)
contained.95.a.5.out.data.drift <- mean({Y.inlabru.drift %>% filter(x > 5) %>% filter(year %in% 2011:2016)}$contained)
...
write.table(list(MDSS.all = MDSS.all.drift,
                 ...
                 above.5.out.data = MDSS.x.above.5.out.data.drift,
                 contained.95.in.data = contained.95.in.data.drift,
                 contained.95.a.5.in.data = contained.95.a.5.in.data.drift,
                 contained.95.out.data = contained.95.out.data.drift,
                 contained.95.a.5.out.data = contained.95.a.5.out.data.drift,
