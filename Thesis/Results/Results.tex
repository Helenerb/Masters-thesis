...
\begin{equation*}
    \sum_x\beta_x = 1, \quad \sum_t\kappa_t = 0, \quad \textcolor{myDarkGreen}{\sum_c\gamma_c = 0}.
\end{equation*}
...
\begin{equation}
    \sum_x\alpha_x = 0,\quad  \sum_x\beta_x = 1, \quad \sum_t\kappa_t = 0, \quad \textcolor{myDarkGreen}{\sum_c\gamma_c = 0}.
